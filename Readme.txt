...
Set the root directory to / and add a build script:
...
Backend Service: Root directory = /server, Start = npm start
Frontend Service: Root directory = /client, Build = npm run build, use Vite static serving
Set VITE_API_URL on the frontend service to point to the backend URL
License
MIT